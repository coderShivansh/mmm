      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
            <h2 className="h2 mb-4">Tech We Use for any kind of MVP Project</h2>
            <p className="text-xl text-gray-600" data-aos="zoom-y-out">
              Below are some modern tech in which our team is proficient with to
              develop your IT needs with modern and reliable technology
            </p>
          </div>
