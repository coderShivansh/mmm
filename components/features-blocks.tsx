      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 mb-4">Path to your MVP!</h2>
            <p className="text-xl text-gray-600">
              Your MVP will undergo a structured yet flexible development
              process. We begin with your vision, planning it into milestones
              and timelines. Starting with design, we create wireframes,
              mockups, and prototypes for your feedback. Next, we leverage our
              expertise to develop your vision into a final MVP product.
            </p>
          </div>
